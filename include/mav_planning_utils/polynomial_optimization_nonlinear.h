...
#ifndef POLYNOMIAL_OPTIMIZATION_NONLINEAR_H_
#define POLYNOMIAL_OPTIMIZATION_NONLINEAR_H_
 ...
 public:
  NonlinearOptimizationParameters()
      ...
      : f_abs(-1),
        ...
        x_rel(-1),
        x_abs(-1),
        initial_stepsize_rel(-1),
        equality_constraint_tolerance(1.0e-3),
        inequality_constraint_tolerance(1.0e-3),
        max_iterations(-1),
        time_penalty(0),
        algorithm(nlopt::LN_COBYLA),
        random_seed(0),
        use_soft_constraints(false),
        soft_constraint_weight(0),
