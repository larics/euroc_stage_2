...
#include "../include/mav_linear_mpc/FireFlyOffsetFreeMPC.h"
...
info->res_ineq = 0;
FireFlyOffsetFreeMPC_LA_VSUBADD3_6(params->umin, FireFlyOffsetFreeMPC_z00, FireFlyOffsetFreeMPC_lbIdx00, FireFlyOffsetFreeMPC_llb00, FireFlyOffsetFreeMPC_slb00, FireFlyOffsetFreeMPC_rilb00, &info->dgap, &info->res_ineq);
FireFlyOffsetFreeMPC_LA_VSUBADD2_6(FireFlyOffsetFreeMPC_z00, FireFlyOffsetFreeMPC_ubIdx00, params->umax, FireFlyOffsetFreeMPC_lub00, FireFlyOffsetFreeMPC_sub00, FireFlyOffsetFreeMPC_riub00, &info->dgap, &info->res_ineq);
